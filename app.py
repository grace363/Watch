...
@app.route("/debug/full_scan")
def debug_full_scan():
    routes_html = "<h2>📍 Routes</h2><ul><li><b>/</b> — methods: []</li><li><b>/register</b> — methods: ['GET', 'POST']</li><li><b>/registration-success/user</b> — methods: []</li><li><b>/registration-success/youtuber</b> — methods: []</li><li><b>/login</b> — methods: ['GET', 'POST']</li><li><b>/confirm_email/<token></b> — methods: []</li><li><b>/logout</b> — methods: []</li><li><b>/user_dashboard</b> — methods: []</li><li><b>/watch_video/<int:video_id></b> — methods: []</li><li><b>/api/heartbeat</b> — methods: ['POST']</li><li><b>/api/complete_video</b> — methods: ['POST']</li><li><b>/api/claim_daily_bonus</b> — methods: ['POST']</li><li><b>/youtuber_dashboard</b> — methods: []</li><li><b>/edit_profile</b> — methods: []</li><li><b>/update_profile</b> — methods: ['POST']</li><li><b>/profile</b> — methods: []</li><li><b>/forgot_password</b> — methods: ['GET', 'POST']</li><li><b>/reset_password/<token></b> — methods: ['GET', 'POST']</li><li><b>/switch-account-type</b> — methods: ['POST']</li><li><b>/watch</b> — methods: ['POST']</li><li><b>/daily-bonus</b> — methods: ['POST']</li><li><b>/withdraw</b> — methods: ['POST']</li><li><b>/admin/panel</b> — methods: []</li><li><b>/admin/user-ips/<int:user_id></b> — methods: []</li><li><b>/upload_video</b> — methods: ['POST']</li><li><b>/upload_success</b> — methods: []</li><li><b>/upload_success/<int:video_id></b> — methods: []</li><li><b>/test</b> — methods: []</li><li><b>/rules_popup</b> — methods: []</li><li><b>/terms</b> — methods: []</li><li><b>/api/user_stats</b> — methods: []</li><li><b>/earnings</b> — methods: []</li><li><b>/api/earnings</b> — methods: []</li></ul>"
    templates_html = "<h2>📁 Templates Used</h2><ul><li>404.html</li><li>500.html</li><li>admin_panel.html</li><li>earnings.html</li><li>edit_profile.html</li><li>forgot_password.html</li><li>home.html</li><li>login.html</li><li>maintenance.html</li><li>profile.html</li><li>register.html</li><li>reset_password.html</li><li>rules_popup.html</li><li>success/user_registration_success.html</li><li>success/youtuber_registration_success.html</li><li>terms.html</li><li>upload_success.html</li><li>user_dashboard.html</li><li>watch_video.html</li><li>youtuber_dashboard.html</li></ul>"
    return routes_html + templates_html
